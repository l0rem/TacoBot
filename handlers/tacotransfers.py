...
from phrases import taco_transfer_phrase, taco_transfer_comment_medium, taco_transfer_comment_high, \
    taco_transfer_comment_low, balance_low_phrase, taco_emoji, self_tacoing_phrase, no_bots_allowed_phrase, \
    no_init_phrase
